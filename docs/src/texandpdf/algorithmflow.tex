...
\usepackage[paperwidth=15in,paperheight=6.25in,margin=0.5in]{geometry}
\usepackage[svgnames]{xcolor}
\usepackage{tikz}
\pagestyle{empty}
% \tikzset{Method/.style={Red, draw=Blue, fill=LightYellow, minimum size=5mm}}
\tikzset{All/.style={Black, draw=Black, fill=LightGrey, minimum size=5mm}}
...
\newcommand\jorisdraw[2]{\draw[thick,-latex] (#1.east)--(#2.west);}
\newcommand\grumpsdraw[2]{\draw[Green,thick,-latex] (#1.east)--(#2.west);}
\newcommand\vanilladraw[2]{\draw[Brown,thick,-latex] (#1.east)--(#2.west);}
...
\makenode{Grumps}{InsideObjective!Grumps}{21,4}{InsideObjective!}{estimators/pml/delta.jl};
\makenode{Grumps}{OutsideObjective1!Grumps}{21,2}{OutsideObjective1!}{estimators/pml/theta.jl};
...
\makenode{Vanilla}{InsideObjective1!Vanilla}{21,-2}{InsideObjective1!}{estimators/vanilla/delta.jl};
...
\makenode{Vanilla}{OutsideObjective1!Vanilla}{21,-4}{OutsideObjective1!}{estimators/vanilla/theta.jl};
