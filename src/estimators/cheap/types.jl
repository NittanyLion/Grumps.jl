...
function DetailedDescription( e :: GrumpsCheapEstimator )
    io = IOBuffer()
    print( io, EstColor, "The estimator used here is the ", EmColor, "cheap version of the Conformant Likelihood Estimator with Exogeneity Restrictions. ", EstColor,
            ...
            "The cheap version computes faster and has the same asymptotic distribution as the full CLEER. ",
            "The only difference is that the full CLEER has somewhat greater robustness to small shares.", Reset )
