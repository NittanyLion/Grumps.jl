...
# precompile( grumps!, ( GrumpsCLEREstimator, Data{Float64}, OptimizationOptions, nothing, StandardErrorOptions ) )
...
precompile(Tuple{Type{Grumps.GrumpsPLMData{T} where T<:AbstractFloat}, Base.Val{:Grumps}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsSources{DataFrames.DataFrame, DataFrames.DataFrame, DataFrames.DataFrame, DataFrames.DataFrame}, Grumps.GrumpsVariables, Array{Array{Int64, 1}, 1}, Bool, LinearAlgebra.UniformScaling{Float64}, SparseArrays.SparseMatrixCSC{Bool, Int64}})
precompile(Tuple{Type{Grumps.GrumpsData{T} where T<:AbstractFloat}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsSources{Grumps.SourceFileCSV, Grumps.SourceFileCSV, Grumps.SourceFileCSV, Grumps.SourceFileCSV}, Grumps.GrumpsVariables})
...
precompile(Tuple{typeof(Grumps.FillZXθ!), Base.Val{:Grumps}, Array{Float64, 1}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsMicroDataHog{Float64}, Grumps.GrumpsOptimizationOptions, Grumps.GrumpsMicroSpace{Float64}})


precompile(Tuple{typeof(Grumps.grumps!), Grumps.GrumpsCLEREstimator, Grumps.GrumpsData{Float64}})
...
precompile(Tuple{typeof(Grumps.ObjectiveFunctionθ1!), Grumps.PMLMarketFGH{Float64}, Array{Float64, 1}, Array{Float64, 1}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsMarketData{Float64, Grumps.GrumpsMicroDataHog{Float64}, Grumps.GrumpsMacroDataAnt{Float64}}, Grumps.GrumpsOptimizationOptions, Grumps.GrumpsMarketSpace{Float64, Grumps.GrumpsMicroSpace{Float64}, Grumps.GrumpsMacroSpace{Float64}}, Bool, Bool, Bool, Int64})
#=  290.8 ms =# precompile(Tuple{Type{Grumps.GrumpsPLMData{T} where T<:AbstractFloat}, Base.Val{:Grumps}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsSources{DataFrames.DataFrame, DataFrames.DataFrame, DataFrames.DataFrame, DataFrames.DataFrame}, Grumps.GrumpsVariables, Array{Array{Int64, 1}, 1}, Bool, LinearAlgebra.UniformScaling{Float64}, SparseArrays.SparseMatrixCSC{Bool, Int64}}) # recompile
...
#=  105.5 ms =# precompile(Tuple{typeof(Grumps.ObjectiveFunctionθ!), Grumps.PMLFGH{Float64}, Float64, Nothing, Nothing, Array{Float64, 1}, Array{Array{Float64, 1}, 1}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsData{Float64}, Grumps.GrumpsOptimizationOptions, Grumps.GrumpsSpace{Float64, Grumps.GrumpsNoSemaphores}, Array{Float64, 1}, Array{Array{Float64, 1}, 1}})
...
#=   20.6 ms =# precompile(Tuple{typeof(Grumps.AθZXθ!), Array{Float64, 1}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsMarketData{Float64, Grumps.GrumpsMicroDataHog{Float64}, Grumps.GrumpsMacroDataAnt{Float64}}, Grumps.GrumpsOptimizationOptions, Grumps.GrumpsSpace{Float64, Grumps.GrumpsNoSemaphores}, Int64})
...
#=  150.8 ms =# precompile(Tuple{Type{Grumps.GrumpsData{T} where T<:AbstractFloat}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsSources{Grumps.SourceFileCSV, Grumps.SourceFileCSV, Grumps.SourceFileCSV, Grumps.SourceFileCSV}, Grumps.GrumpsVariables}) # recompile
#=  286.9 ms =# precompile(Tuple{Type{Grumps.GrumpsPLMData{T} where T<:AbstractFloat}, Base.Val{:Grumps}, Grumps.GrumpsCLEREstimator, Grumps.GrumpsSources{DataFrames.DataFrame, DataFrames.DataFrame, DataFrames.DataFrame, DataFrames.DataFrame}, Grumps.GrumpsVariables, Array{Array{Int64, 1}, 1}, Bool, LinearAlgebra.UniformScaling{Float64}, SparseArrays.SparseMatrixCSC{Bool, Int64}}) # recompile
#=  229.1 ms =# precompile(Tuple{typeof(Grumps.grumps!), Grumps.GrumpsCLEREstimator, Grumps.GrumpsData{Float64}}) # recompile
...
#=   50.9 ms =# precompile(Tuple{typeof(Grumps.VarEst), Grumps.GrumpsCLEREstimator, Base.Val{:θ}, Base.Val{:θ}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
#=    2.2 ms =# precompile(Tuple{typeof(Grumps.Bread), Grumps.GrumpsCLEREstimator, Base.Val{:θ}, Base.Val{:θ}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
#=    2.0 ms =# precompile(Tuple{typeof(Grumps.Meat), Grumps.GrumpsCLEREstimator, Base.Val{:θ}, Base.Val{:θ}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
#=   16.7 ms =# precompile(Tuple{typeof(Grumps.Bread), Grumps.GrumpsCLEREstimator, Base.Val{:θ}, Base.Val{:δ}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
#=    3.2 ms =# precompile(Tuple{typeof(Grumps.Meat), Grumps.GrumpsCLEREstimator, Base.Val{:δ}, Base.Val{:θ}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
#=    3.5 ms =# precompile(Tuple{typeof(Grumps.Meat), Grumps.GrumpsCLEREstimator, Base.Val{:θ}, Base.Val{:δ}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
#=    5.6 ms =# precompile(Tuple{typeof(Grumps.Meat), Grumps.GrumpsCLEREstimator, Base.Val{:δ}, Base.Val{:δ}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
#=   69.6 ms =# precompile(Tuple{typeof(Grumps.VarEst), Grumps.GrumpsCLEREstimator, Base.Val{:β}, Base.Val{:β}, Int64, Int64, Grumps.GrumpsIngredients{Float64}})
